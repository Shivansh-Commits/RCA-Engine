...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader splashLoader = new FXMLLoader(getClass().getResource("/com/l3/apipnrengine/api/SplashScreen.fxml"));
        ...
        splashController.startProgress(() -> {
            try {
                ...
                FXMLLoader mainLoader = new FXMLLoader(getClass().getResource("/com/l3/apipnrengine/api/MainView.fxml"));
